                ...
                <Card>
                  <CardContent className="flex items-start gap-4 p-4 md:p-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm md:text-base">Luni - Duminică: 10:00 - 22:00</p>
                    </div>
                  </CardContent>
                </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="mb-2">Adresă: Strada Barajul Uzului CA 9</p>
              <p className="mb-2">Telefon: 0770 285 661</p>
